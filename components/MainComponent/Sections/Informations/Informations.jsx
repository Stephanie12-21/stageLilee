...
const Informations = () => {
  ...
  const cards = [
    { src: "/informations/Figure.svg", title1: "Services très", title2: "rapides" },
    { src: "/informations/Figure(3).svg", title1: "Payement en ligne", title2: "sécurisé" },
    { src: "/informations/Figure(1).svg", title1: "Devenir membre", title2: "facilement" },
    { src: "/informations/Figure(2).svg", title1: "Services clients", title2: "24/7" },
  ];
