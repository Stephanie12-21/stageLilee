...
export default function Login() {
  ...
  const [error, setError] = useState(null); // Pour afficher les erreurs si le statut est différent de "ACTIF"
  const [open, setOpen] = useState(false); // Contrôle l'ouverture de l'alert dialog
  const [alertMessage, setAlertMessage] = useState(""); // Message à afficher dans l'alert
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (loginData?.error) {
        ...
        setAlertMessage("Identifiants incorrects"); // Afficher une erreur si la connexion échoue
        setOpen(true); // Ouvrir l'alert dialog
        return;
      }
  ...
  return (
    <div className="w-full h-screen lg:grid lg:grid-cols-2">
      ...
      {/* AlertDialog ShadCN pour afficher les erreurs */}
...
//       if (loginData?.error) {
//         console.error("Login error:", loginData.error);
//         setError("Identifiants incorrects"); // Afficher une erreur si la connexion échoue
//         return;
//       }
