...
//         </div>
//         {type === "chat" && (
//           <p className="text-sm text-gray-600 truncate">{latestMessageText}</p>
//         )}
//       </div>
//     </div>
//   );
...
//       <div className="flex justify-between border-b p-4 bg-white">
//         <button
...
//       <div className="w-full md:w-1/3 bg-white border-r shadow-md">
...
//             <p className="text-lg">Sélectionnez un chatroom pour commencer.</p>
//           </div>
//         )}
//       </div>
//     </div>
