...
//       icon: <Text />,
//       onClick: () => {
//         editor.chain().focus().unsetAllMarks().setParagraph().run(); // Réinitialiser les styles
//         editor
//           .chain()
//           .focus()
//           .setNode("paragraph", { style: "text-[16px]" })
//           .run(); // Appliquer le style
//       },
//       active: editor.isActive("paragraph", { style: "text-[16px]" }), // Vérifie si le style est appliqué
//     },
//     {
//       icon: <Heading2 />,
...
//         }
//         // Vérifie si un lien est actif avant de désactiver son style
//         if (editor.isActive("link")) {
//           editor.chain().focus().unsetLink().run(); // Désactive le style du lien
//         }
//       }
//     };
