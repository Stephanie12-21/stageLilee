...
//           setFormData({
//             titre: data.titre,
//             description: data.description ? JSON.parse(data.description) : {}, // Remplir avec la description (si elle existe)
//             category: data.categorieAnnonce,
//             localisation: data.localisation,
//             adresse: data.adresse,
//             files: [], // Initialiser le tableau d'images vides
//           });
//           setContenu(data.description ? JSON.parse(data.description) : {}); // Charger le JSON si existant
//         })
...
//     formDataToSend.append("description", JSON.stringify(contenu)); // Convertir en JSON
